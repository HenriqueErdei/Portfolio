...
const Header = () => {
  ...
  return (
    <motion.header 
      className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 border-4 border-blue-500"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            {navItems.map((item, index) => (
              <AnimatedElement key={item.href} animation="slideDown" delay={0.3 + index * 0.1}>
                <Link
                  href={item.href}
          ...
          {/* Right side - Language Switcher and Social Links */}
          <div className="flex items-center space-x-4">
            {/* Language Switcher */}
            <AnimatedElement animation="slideLeft" delay={0.1}>
              <LanguageSwitcher />
            </AnimatedElement>
            ...
            {/* Email */}
            <a
              href="mailto:henriqueerdeijob@gmail.com"
              className="text-gray-900 hover:text-black transition-colors p-2 rounded-full hover:bg-gray-100"
              title="Email"
            >
              ...
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                {navItems.map((item, index) => (
                  ...
                  >
                    <Link
                      href={item.href}
                      className="block px-3 py-2 text-gray-700 hover:text-black hover:bg-gray-100 rounded-md transition-colors"
